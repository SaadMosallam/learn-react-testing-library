...
describe('test drinks search', () => { 
    ...
    test('drinks search with no drink results', async () => {
        ...
        const noResults = await screen.findByRole('heading', { name: /No drinks found/i });
    ...
    test('drinks search when service unavailable', async () => {
        ...
        const serviceUnavailable = await screen.findByRole('heading', { name: /Service unavailable/i });
